...
-- ------------------------------------------------------------
-- Utilisateurs
-- Administrateur créé en BDD uniquement (impossible via l'app)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Plats (catégorisés entrée/plat/dessert)
-- plat_id=9 "Fondant au chocolat" partagé par menus 3 et 4
-- ------------------------------------------------------------
...
-- Menu Événement (4) — plat_id=9 partagé
...
(2, 4),(2, 5),(2, 6),
(3, 7),(3, 8),(3, 9),
(4,10),(4,11),(4,12),(4, 9); -- fondant partagé avec menu 3

-- Allergènes par plat
INSERT INTO plat_allergene (plat_id, allergene_id) VALUES
(1,  7), -- velouté potiron : lait
(1, 12), -- velouté : sulfites (foie gras)
(2,  1), -- chapon : gluten (sauce)
(3,  1), -- bûche : gluten
(3,  3), -- bûche : œufs
(3,  7), -- bûche : lait
(4,  7), -- asperges burrata : lait
(4,  3), -- burrata : œufs
(5,  7), -- risotto : lait (parmesan)
(6,  1), -- tarte citron : gluten
(6,  3), -- tarte citron : œufs
(6,  7), -- tarte citron : lait (beurre)
(9,  7), -- fondant chocolat : lait
(9,  3), -- fondant chocolat : œufs
(10,12), -- foie gras : sulfites
(11, 1), -- bœuf wellington : gluten (pâte)
(11, 3), -- bœuf wellington : œufs
(12, 7), -- soufflé : lait
(12, 3); -- soufflé : œufs

-- ------------------------------------------------------------
-- Commandes (un exemplaire par statut du workflow)
-- ------------------------------------------------------------
...
-- 1. nouvelle — Alice, Menu Classique, 8 personnes, Bordeaux
(1, 'VG-20260525-00001', 4, 3, '2026-05-25 14:30:00', '2026-06-15', '12:00:00',
 '25 avenue de la Paix', 'Bordeaux', 8, 280.00, 0.00, 280.00,
 'nouvelle', 0, 0),

-- 2. acceptee — Bob, Menu Noël, 15 personnes (≥10+5 → -10%), Mérignac
(2, 'VG-20260520-00002', 5, 1, '2026-05-20 10:00:00', '2026-07-04', '13:00:00',
 '15 rue des Pins', 'Mérignac', 15, 607.50, 0.00, 607.50,
 'acceptee', 0, 0),

-- 3. en_preparation — Alice, Menu Pâques, 10 personnes, hors Bordeaux 25km
(3, 'VG-20260515-00003', 4, 2, '2026-05-15 16:00:00', '2026-06-20', '11:30:00',
 '8 chemin des Collines', 'Mérignac', 10, 380.00, 19.75, 399.75,
 'en_preparation', 0, 0),

-- 4. en_cours_livraison — Claire, Menu Événement, 25 personnes (≥20+5 → -10%)
(4, 'VG-20260510-00004', 6, 4, '2026-05-10 11:30:00', '2026-05-26', '12:00:00',
 '1 allée du Château', 'Pessac', 25, 1237.50, 13.85, 1251.35,
 'en_cours_livraison', 1, 0),

-- 5. terminee — Bob, Menu Classique, 6 personnes, Mérignac
(5, 'VG-20260410-00005', 5, 3, '2026-04-10 09:00:00', '2026-04-20', '12:00:00',
 '7 rue des Vignes', 'Mérignac', 6, 210.00, 18.81, 228.81,
 'terminee', 0, 0),

-- 6. en_attente_retour_materiel — Alice, Menu Événement, 30 personnes (≥20+5 → -10%)
(6, 'VG-20260415-00006', 4, 4, '2026-04-15 10:00:00', '2026-05-05', '11:00:00',
 '25 avenue de la Paix', 'Bordeaux', 30, 1485.00, 0.00, 1485.00,
 'en_attente_retour_materiel', 1, 0),

-- 7. terminee — Claire, Menu Noël, 12 personnes (≥10+5 → -10%), hors BDX 30km
(7, 'VG-20260301-00007', 6, 1, '2026-03-01 14:00:00', '2026-03-15', '12:00:00',
 '14 impasse des Roses', 'Pessac', 12, 486.00, 22.70, 508.70,
 'terminee', 0, 0);
...
-- Commande 5 (terminee directe, sans prêt matériel)
...
-- Commande 6 (en_attente_retour_materiel)
...
-- Commande 7 (terminee via retour matériel non applicable)
...
(1, 5, 5, 5,
 'Service impeccable, plats délicieux et livrés à l''heure. Le chapon était fondant à souhait. Je recommande vivement !',
 'valide', '2026-04-21 10:15:00'),
(2, 6, 7, 4,
 'Très bon repas dans l''ensemble, le velouté de potiron était excellent. Légère déception sur la bûche un peu sèche.',
 'en_attente', '2026-03-16 09:30:00');
...
('prospect@example.com',
 'Demande de devis pour mariage',
 'Bonjour, je souhaite organiser un mariage en septembre 2026 pour environ 80 personnes. Pouvez-vous me proposer une formule adaptée ?',
 '2026-05-24 11:00:00', 0);
